...
const addK3 = async (game) => {
  try {
    ...
    if (game == 3) minutes = 3;
    if (game == 5) minutes = 5;
    if (game == 10) minutes = 10;

    let timeNow = Date.now();
    let gameRepresentationId = GameRepresentationIds.G5D[game];
    let NewGamePeriod = generatePeriod(gameRepresentationId, minutes);
      ...
      for (let i = 0; i < arr1.length; i++) {
        if (arr1[i] != "") {
          ...
          if (check1 || check2) {
            ...
            let total = orders.money / (lengthArr + arr1.length);
      ...
      for (let i = 0; i < arr3.length; i++) {
        if (arr3[i] != "") {
          ...
          if (check1 || check2) {
            ...
            let total = orders.money / (lengthArr + bale);
    ...
    if (orders.typeGame == "three-same") {
      ...
      for (let i = 0; i < arr1.length; i++) {
        if (arr1[i] != "") {
          ...
          if (check1) {
            let total = orders.money / (arr1.length + bala);
    ...
    if (orders.typeGame == "unlike") {
      ...
      for (let i = 0; i < arr1.length; i++) {
        if (arr1[i] != "") {
          ...
          if (!check1) {
            let total = orders.money / (arr1.length + bala + bala2);
            nhan_duoc += total * 34.56 - orders.fee;
            if (arr2 == "u") {
              let total = orders.money / (1 + bala + bala2);
      ...
      for (let i = 0; i < arr3.length; i++) {
        if (arr1[i] != "") {
          ...
          if (!check1) {
            let total = orders.money / (arr3.length + bala);
