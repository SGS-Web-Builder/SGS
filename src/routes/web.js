...
const initWebRouter = (app) => {
  ...
  router.get(
    "/api/commission",
    middlewareController,
    promotionController.getCommissionDetailsByDate,
  );
  router.get(
    "/api/rebate_commission",
    middlewareController,
    promotionController.getCurrentRebateInfo,
  );
  router.post(
    "/api/rebate_commission",
    middlewareController,
    promotionController.oneClickRebateClaim,
  );
  router.get(
    "/api/vip/info",
    middlewareController,
  ...
  router.get(
    "/admin/manager/index/30",
    adminController.middlewareAdminController,
    adminController.adminPage30,
  ); // get info account
